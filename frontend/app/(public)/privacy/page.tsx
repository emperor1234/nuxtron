  ...
  return (
    <section className="mk-section pt-40">
      <div className="mk-container max-w-3xl">
        ...
        <h1 className="mb-4 text-4xl font-semibold tracking-tight text-[#0b1b2b] sm:text-5xl">Privacy Policy</h1>
        ...
        <p className="mt-14 border-t border-[#dbe6ee] pt-8 text-sm text-[#8595a8]">
          ...
          <a href="mailto:privacy@nuxtron.app" className="text-[#0c8fcc] hover:underline">
            privacy@nuxtron.app
          </a>
          .
        </p>
