    ...
    <>
      <section className="mk-section pt-40 text-center">
        <div className="mk-container max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-relaxed text-[#55677c]">
      ...
      <section className="mk-section">
        <div className="mk-container max-w-3xl rounded-2xl border border-[#dbe6ee] bg-[#0b1b2b] p-10 sm:p-14">
          <h2 className="mb-4 text-3xl font-semibold tracking-tight text-white">How we build</h2>
          <div className="space-y-4 text-[15px] leading-relaxed text-[#c3d8e8]">
            <p>
      ...
      <section className="mk-section text-center">
        <div className="mk-container max-w-2xl">
          ...
          <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
            ...
            <Link href="/careers" className="mk-btn-secondary">
              We&apos;re hiring
            </Link>
          </div>
        </div>
